...
public class ProductIO {
    ...
    public static void setFactory(ProductFactory productFactory) {
    ...
    public static Product readProduct(Reader in) {
        ...
        try {
            ...
            for (int i = 0; i < reviewCount; i++) {
                tokenizer.nextToken();
                tokenizer.nextToken();
                product.addReview((int) tokenizer.nval);
            }
            product.setName(name);
            product.setPrice(price);
            return product;
    ...
    public static Product unmodifiableProduct(Product product){
        return new ProductUnmodifiable(product);
    }
}
