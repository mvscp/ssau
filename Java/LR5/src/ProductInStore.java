...
class ProductInStore implements Product, Serializable {
    ...
    public void setReview(int index, int value) {
        reviews.set(index, value);
    }

    public int getReview(int index) {
    ...
    public void output(OutputStream out) {
        try {
            ...
            dos.writeUTF(name);
            dos.writeInt(price);
            dos.writeUTF(String.valueOf(stockQuantity));
    ...
    public void write(Writer out) {
        try {
            out.write( name + " " + price + " " + stockQuantity + " " + reviews.size() + " " + reviews + "\n");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
